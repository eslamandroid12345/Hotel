            ...
            <div class="app-three">
                ...
                <div class="app-seven">
                    ...
                    <form action="{{route('login')}}" method="POST">
                        ...
                        <div class="add-onex">
                            <input type="email" placeholder="برجاء ادخال البريد الالكتروني"  name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        </div>
                        <div class="add-onex">
                            <input type="password" placeholder="كلمه المرور"  name="password" required autocomplete="current-password">
